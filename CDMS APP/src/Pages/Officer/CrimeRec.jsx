...
const CrimeRec = ({ selectedCrime, setSelectedCrime }) => {
  ...
  useEffect(() => {
    const fetchCrimeData = async () => {
      ...
      try {
        // Fetch crimes related to investigations for the user with the specific ID
        const response = await api.get(`/Investigations/CrimeRec`, {
          params: { id },
        });
        ...
        // Filter out closed or solved cases
